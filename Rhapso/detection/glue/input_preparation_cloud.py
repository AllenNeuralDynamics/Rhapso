...
from pyspark.sql.types import StructType, StructField, IntegerType, StringType, BooleanType, FloatType, ArrayType, MapType, Row
from pyspark.sql.functions import col, explode, udf, collect_list, udf
from awsglue.context import GlueContext
from awsglue.job import Job
from pyspark.sql.utils import AnalysisException

# This version is designed to run in AWS Glue console as a Glue Job
# Job Params are:
# --JOB_NAME - input_preparation-ipd 
...
if __name__ == "__main__":
    ...
    base_output_path = f"s3://{input_prep.bucket_name}/inputprep-output-ipd"
