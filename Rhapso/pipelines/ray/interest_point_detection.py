...
class InterestPointDetection:
    def __init__(self, dsxy, dsz, min_intensity, max_intensity, sigma, threshold, file_type, xml_file_path, 
                 ...
                 max_spots, median_filter, overlap_only):
        self.dsxy = dsxy
        self.dsz = dsz
    ...
    def detection(self):
        ...
        overlap_detection = OverlapDetection(view_transform_matrices, dataframes, self.dsxy, self.dsz, self.image_file_prefix, 
                                             self.file_type, self.overlap_only)
        ...
        @ray.remote
        def process_peak_detection_task(chunk_metadata, new_dsxy, new_dsz, level, min_intensity, max_intensity, sigma, threshold,
            ...
            try:
                ...
                view_id, interval, image_chunk, offset, lb = image_fetcher.run(chunk_metadata, new_dsxy, new_dsz, level)
        ...
        # Submit tasks to Ray
        futures = [process_peak_detection_task.remote(chunk_metadata, new_dsxy, new_dsz, level, self.min_intensity, self.max_intensity, 
