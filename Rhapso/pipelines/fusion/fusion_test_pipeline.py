...
3. Run this file:
    - Run this file: 'python Rhapso/pipelines/fusion/fusion_test_pipeline.py' 
"""
...
if __name__ == '__main__':
    ...
    INPUT_PATH = "/home/martin/Documents/Allen/BigStitcherSpark Example Datasets/Interest Points (unaligned)/IP_TIFF_XML/4. IP_TIFF_XML (after fusion)"

    # Path to the output Zarr file where the fused dataset will be stored
    OUTPUT_PATH = "/home/martin/Documents/Allen/BigStitcherSpark Example Datasets/Interest Points (unaligned)/IP_TIFF_XML/4. IP_TIFF_XML (after fusion)/fused_output.zarr"

    # Path to the output Zarr file where the multiscale representation of the fused dataset will be stored
    MULTISCALE_OUTPUT_PATH = "/home/martin/Documents/Allen/BigStitcherSpark Example Datasets/Interest Points (unaligned)/IP_TIFF_XML/fusedMultiscaleOutput.zarr"
