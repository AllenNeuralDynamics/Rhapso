...
class Solver:
    def __init__(self, file_source, xml_file_path_output, xml_bucket_name, xml_file_path, data_prefix, fixed_views,
                 run_type, relative_threshold, absolute_threshold, min_matches, damp, max_iterations,
                 max_allowed_error, max_plateauwidth, metrics_output_path):
    ...
    def solve(self):
        ...
        global_optimization = GlobalOptimization(tc, self.fixed_views, self.data_prefix, self.relative_threshold,
