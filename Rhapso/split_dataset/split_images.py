...
#     def load_interest_points(self, fake_label):
#         full_path = (self.n5_path + "interestpoints.n5").rstrip("/")
#         interest_points = {}
...
#                 # Zarr v3 path.
#                 store = zarr.storage.LocalStore(full_path)
#             else:
#                 # Zarr v2 path.
...
#             data = root[interestpoints_prefix][:]
...
#                 "parameters_fake": (
#                     f"Fake points for image splitting: "
#                     f"overlapPx={overlap_px}, "
#                     f"targetSize={self.target_image_size}, "
#                     f"minStepSize={self.min_step_size}, "
#                     f"optimize=true, "
#                     f"pointDensity={self.point_density}, "
#                     f"minPoints={self.min_points}, "
#                     f"maxPoints={self.max_points}, "
#                     f"error={self.error}, "
