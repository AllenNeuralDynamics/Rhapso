...
def visualize_points(full_path, output_path):
...
# visualize_points('/root/capsule/scratch/loop_0/interestpoints.n5/tpId_0_viewSetupId_0/beads/interestpoints/loc')
