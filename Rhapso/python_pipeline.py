...
overlap_detection = OverlapDetection(
    view_transform_matrices, dataframes, dsxy, dsz, prefix, file_type
)
...
interest_point_detection = PythonInterestPointDetection(
    dataframes, overlapping_area, dsxy, dsz, prefix, file_type, image_bucket_name
)
...
advanced_refinement = AdvancedRefinement(interest_points, overlapping_area)
